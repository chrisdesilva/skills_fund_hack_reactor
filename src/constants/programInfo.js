...
export const leadContent = {
	...
	paragraph: `${schoolName} supports its students on their coding journey by providing full-time, part-time, and remote options. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
